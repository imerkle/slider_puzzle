...
class PuzzleAnimator implements PuzzleProxy {
  ...
  @override
  Point<double> location(int index) => locations[index].location;
  ...
  PuzzleAnimator._(this._puzzle)
      : locations = List.generate(_puzzle.length, (i) {
          return Body.raw(
  ...
  void _shake(int tileValue) {
    ...
    locations[tileValue].kick(deltaDouble);
  }
